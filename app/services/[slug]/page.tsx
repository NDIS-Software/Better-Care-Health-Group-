...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return service ? { title: service.title, description: `${service.summary} Mobile visits across Greater Melbourne.` } : {};
}
