...
export function Footer() {
  return <footer className="site-footer"><div className="site-shell">
    <div className="footer-grid">
      <div><img className="footer-logo" src="/brand/better-care-logo.png" alt="Better Care Health Group" width="420" height="140" loading="lazy" /><p className="footer-copy">Mobile allied health and support across Melbourne. Care that fits around real homes, routines and goals.</p></div>
