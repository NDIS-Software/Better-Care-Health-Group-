...
export function Footer() {
  ...
  return <footer className="site-footer"><div className="site-shell">
    <div className="footer-grid">
      ...
      <div><div className="footer-title">{zh ? "浏览" : "Explore"}</div><div className="footer-links"><Link href={path("/services")}>{zh ? "服务项目" : "Services"}</Link><Link href={path("/about")}>{zh ? "关于我们" : "About us"}</Link></div></div>
